...
public class ConcatenatedRequest implements HttpServletRequest {
    HttpServletRequest req;
    Map body;
    String pathInfo;
    public ConcatenatedRequest(HttpServletRequest req2, String cont) {
        req=req2;
        try {
            body=(Map)JSON.decode(cont);
        } catch (JSONException e) {
            System.out.println("Err ! cont="+cont);
            throw e;
        }
        pathInfo=(String)body.get("pathInfo");
    }
    ...
    public String getParameter(String arg0) {
        return (String) body.get(arg0);//req.getParameter(arg0);
    }
