...
public class NodeJSRequest implements Wrappable {
	public BlankScriptableObject body, query;
	HttpServletRequest req;
	public NodeJSRequest(HttpServletRequest req) {
		query=body=new BlankScriptableObject();
		for (Object k:req.getParameterMap().keySet()) {
			String s=req.getParameter(k+"");
			ScriptableObject.putProperty(body, k+"", s);
		}
		this.req=req;
	}
